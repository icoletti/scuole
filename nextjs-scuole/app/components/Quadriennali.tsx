...
// Definizione di un array di oggetti School
        ...
        <div>
            ...
            <div className='titolo-quadriennali'>
                <div className=' text-9xl font-semibold pt-20 pb-16 ml-9'>
                    {/* Commento: Titolo della sezione Quadriennali */}
            ...
            <div>
                {/* Commento: Logo e descrizione del Polo Veronesi */}
                ...
                <div>
                    {/* Commento: Pulsante per il sito ufficiale del Polo Veronesi */}
                    ...
                    {/* Commento: Pulsante per il video di presentazione del Polo Veronesi */}
                    <button className='bg-primary-blue text-white px-3 py-2 rounded-3xl' onClick={handleClick}> video presentazione
                        {/* Commento: Mostra il video solo se showVideo è true */}
                        {showVideo && (
            ...
            <div className='pt-20 pb-16'></div>
            <div>
                {/* Commento: Logo e descrizione dell'Istituto Marconi */}
                ...
                <div>
                    {/* Commento: Pulsante per il sito ufficiale dell'Istituto Marconi */}
                    ...
                    {/* Commento: Pulsante per il video di presentazione dell'Istituto Marconi */}
                    <button className='bg-primary-blue text-white px-3 py-2 rounded-3xl' onClick={handleClick}> video presentazione
                        {/* Commento: Mostra il video solo se showVideo è true */}
                        {showVideo && (
                            <video controls width="500">
            ...
            <div className='pt-20 pb-16'></div>
            <div>
                {/* Commento: Logo e descrizione dell'ITET Fontana */}
                ...
                <div>
                    {/* Commento: Pulsante per il sito ufficiale dell'ITET Fontana */}
                    ...
                    {/* Commento: Pulsante per il video di presentazione dell'ITET Fontana */}
                    <button className='bg-primary-blue text-white px-3 py-2 rounded-3xl' onClick={handleClick}> video presentazione
                        {/* Commento: Mostra il video solo se showVideo è true */}
                        {showVideo && (
                            <video controls width="500">
